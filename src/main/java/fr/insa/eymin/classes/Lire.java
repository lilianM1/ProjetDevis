...
public class Lire {
    ...
    public static int entierCompris(int min, int max) // lire un nombre entier compris dans un intervalle ferme
    {
        ...
        do {
            ...
            try {
                ...
                System.out.print(" > Veuillez entrer un nombre entier compris entre " + separer(min) + " et "
                        + separer(max) + " : ");
                erreur = true;
            }
    ...
    // -------------------------------------------------------------------------------------------------------------------
    public static boolean chaineEstUnEntierPositif(String chaine) // test si une chaine est un entier strictement
                                                                  // positif
    {
        int i;
    ...
    // -------------------------------------------------------------------------------------------------------------------
    public static boolean chaineEstUnEntierNegatif(String chaine) // test si une chaine est un entier strictement
                                                                  // negatif
    {
        int i;
